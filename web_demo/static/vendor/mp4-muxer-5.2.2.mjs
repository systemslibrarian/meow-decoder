 ...
 *
 * Vendored from npm: `npm pack mp4-muxer@5.2.2` → build/mp4-muxer.mjs
 * Source upstream:   https://github.com/Vanilagy/mp4-muxer
 * SHA-256 (original, before this header):
 *   d2c4c782f180c86ed30b1f5d9487a34a0d370bf9b4535285734ea187d38f9bb5
 *
 * Used by: web_demo/static/convert-webm-to-mp4.js (Branch 2 WebCodecs
 * decode-encode-mux pipeline — gemini #5).
 *
 * Do not edit. To upgrade: re-run `npm pack mp4-muxer@<new>` and
 * replace this file (preserve this comment block).
 */
