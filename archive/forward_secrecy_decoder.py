...
class ForwardSecrecyFountainDecoder:
    ...
    def process_secure_droplet(
        self, encrypted_data: bytes, nonce: bytes, block_indices: List[int], seed: int
    ) -> bool:
        """
...
def parse_manifest_v3_forward_secrecy(
    manifest_extensions: bytes,
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        complete = decoder.process_secure_droplet(
            encrypted_data=ciphertext, nonce=nonce, block_indices=[i], seed=i
        )
