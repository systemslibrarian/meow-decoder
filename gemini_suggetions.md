...
Status: strategic roadmap note, updated on 2026-05-04 to reflect current repo state.
...
- Item 5: strategically useful, and a major branch of this work is now shipped
...
Current status: strategically useful, and a major branch of this work is now shipped.
...
- Still a strong strategic direction
- Significant implementation has already landed; remaining work is product refinement rather than core feasibility
...
4. improve product-level transport UX around the now-shipped video path
...
- gemini #5 is no longer hypothetical; the WebM to MP4 path is shipped
