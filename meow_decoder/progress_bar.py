...
class ProgressBar:
    ...
    def finish(self, message: str = "Complete!") -> None:
        ...
        print(f"{self._color('✅', self.GREEN)} {message} " f"({elapsed}, avg {speed})")
...
class FountainProgressBar(ProgressBar):
    ...
    def update_decoding(
        self, blocks_decoded: int, droplets_received: int, bytes_count: int = 0
    ) -> None:
...
def create_progress(
    total: int, title: str = "Progress", fountain: bool = False, **kwargs
) -> ProgressBar:
    """
