...
class GIFEncoder:
    ...
    def create_gif(
        self, frames: List[Image.Image], output_path: Path, optimize: bool = False
    ) -> int:
        """
    ...
    def create_gif_bytes(self, frames: List[Image.Image], optimize: bool = False) -> bytes:
        """
...
class GIFOptimizer:
    ...
    @staticmethod
    def optimize_gif(
        input_path: Path, output_path: Path, colors: int = 256, reduce_size: bool = True
    ) -> Tuple[int, int]:
        """
        Optimize GIF file.
