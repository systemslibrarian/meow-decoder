...
# Argon2id parameters (OWASP-recommended, tuned for security over speed)
# ~500-800ms on modern hardware (2024+)
ARGON2_MEMORY = 65536       # 64 MiB (OWASP minimum recommendation)
ARGON2_ITERATIONS = 3       # 3 passes (OWASP minimum)
