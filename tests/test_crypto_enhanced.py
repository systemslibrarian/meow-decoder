...
class TestEncryptFileBytes:
    ...
    def test_forward_secrecy_flag(self):
        ...
        comp, sha, salt, nonce, cipher = encrypt_file_bytes(
            data, password, use_forward_secrecy=True
        )
    ...
    def test_encryption_failure_handling(self):
        ...
        with mock.patch(
            "meow_decoder.crypto_enhanced.derive_key", side_effect=Exception("Key error")
        ):
