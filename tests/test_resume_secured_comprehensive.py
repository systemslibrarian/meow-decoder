...
class TestKeyDerivation:
    ...
    def test_cat_derives_deterministic_key(self, resume_manager, sample_manifest, valid_password):
    ...
    def test_cat_derives_different_keys_for_different_salts(self, resume_manager, valid_password):
...
class TestSessionIdGeneration:
    ...
    def test_cat_generates_session_id_with_correct_format(self, resume_manager, sample_manifest):
    ...
    def test_cat_generates_deterministic_session_id(self, resume_manager, sample_manifest):
    ...
    def test_cat_generates_different_ids_for_different_manifests(self, resume_manager):
    ...
    def test_cat_session_id_only_contains_valid_chars(self, resume_manager, sample_manifest):
...
class TestStateLoadingUnencrypted:
    ...
    def test_cat_loads_saved_state(self, temp_state_dir, sample_manifest, sample_decoder):
    ...
    def test_cat_loads_manifest_data(self, temp_state_dir, sample_manifest, sample_decoder):
...
class TestDecoderRestoration:
    ...
    def test_cat_restores_decoder_from_state(self, temp_state_dir, sample_manifest):
...
class TestSessionListing:
    ...
    def test_cat_lists_available_sessions(self, temp_state_dir, sample_manifest, sample_decoder):
...
class TestSessionDeletion:
    ...
    def test_cat_deletes_session(self, temp_state_dir, sample_manifest, sample_decoder):
...
class TestAutoSaveDecoder:
    ...
    def test_cat_creates_autosave_decoder(self, temp_state_dir, sample_manifest, valid_password):
    ...
    def test_cat_autosave_adds_droplet(self, temp_state_dir, sample_manifest, sample_droplet):
    ...
    def test_cat_autosave_triggers_save_at_interval(self, temp_state_dir, sample_manifest):
    ...
    def test_cat_autosave_delegates_is_complete(self, temp_state_dir, sample_manifest):
...
class TestHelperFunctions:
    ...
    def test_cat_resume_from_session_returns_none_for_missing(self, temp_state_dir):
    ...
    def test_cat_create_resumable_decoder(self, temp_state_dir, sample_manifest):
...
class TestErrorHandling:
    ...
    def test_cat_handles_permission_error_on_save(
...
class TestThreadSafety:
    ...
    def test_cat_concurrent_saves_dont_corrupt(self, temp_state_dir, sample_manifest):
...
class TestIntegrationScenarios:
    ...
    def test_cat_encrypted_full_cycle(self, temp_state_dir, sample_manifest, valid_password):
