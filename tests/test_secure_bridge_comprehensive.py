...
class TestSecureBridgeMeow:
    ...
    def test_secure_bridge_encrypt_with_handle(self, mock_rust_backend, sample_plaintext, sample_aad):
        ...
        with patch.dict('sys.modules', {'meow_crypto_rs': mock_rust_backend}):
            with patch('meow_decoder.secure_bridge.RUST_AVAILABLE', True):
                with patch('meow_decoder.secure_bridge.meow_crypto_rs', mock_rust_backend):
                    ...
                    nonce, ciphertext = bridge.encrypt_with_handle(handle, sample_plaintext, sample_aad)
            ...
            with patch('meow_decoder.secure_bridge.RUST_AVAILABLE', True):
                with patch('meow_decoder.secure_bridge.meow_crypto_rs', mock_rust_backend):
                    ...
                    with SecureBridge() as bridge:
                        ...
                        nonce, ciphertext = bridge.encrypt_with_handle(handle, original_plaintext, aad)
