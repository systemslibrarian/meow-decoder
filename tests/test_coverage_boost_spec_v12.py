...
class TestSteganography:
    ...
    def test_extract_truncated_payload(self):
        ...
        from meow_decoder.spec_v12.steganography import embed_in_gif, extract_from_gif, MEOW_PAYLOAD_MARKER
...
class TestKeyManagement:
    ...
    def test_ed25519_pk_to_x25519_pk(self):
        ...
        from meow_decoder.spec_v12.key_management import (
            SoftwareBackend, ed25519_pk_to_x25519_pk
        )
        backend = SoftwareBackend()
    ...
    def test_ed25519_sk_to_x25519_sk(self):
        ...
        from meow_decoder.spec_v12.key_management import (
            SoftwareBackend, ed25519_sk_to_x25519_sk
        )
        backend = SoftwareBackend()
