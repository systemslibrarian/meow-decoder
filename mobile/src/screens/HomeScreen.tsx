  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          >
            {loading ? (
              ...
              <Text style={styles.primaryButtonText}>📂 Import Capture Request (JSON)</Text>
            )}
          </TouchableOpacity>
          ...
          <View style={styles.altButtonRow}>
            ...
            >
              <Text style={styles.altButtonText}>📷 Scan Request QR (from desktop)</Text>
            </TouchableOpacity>
        ...
        {/* Helper context text */}
        <Text style={styles.captureHelperText}>A Capture Request is generated by meow-decoder on your computer.</Text>
